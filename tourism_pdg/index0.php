...
<html lang="en">
  <head>
    ...
    <title>Padang Toursim</title>

    <!-- Bootstrap core CSS -->
    <link href="assets/_old/css/bootstrap.css" rel="stylesheet">
    <!--external css-->
    <link href="assets/_old/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="assets/_old/css/zabuto_calendar.css">
    <link rel="stylesheet" type="text/css" href="assets/_old/js/gritter/css/jquery.gritter.css" />
    <link rel="stylesheet" type="text/css" href="assets/_old/lineicons/style.css">    
    
    <!-- Custom styles for this template -->
    <link href="assets/_old/css/style.css" rel="stylesheet">
    <link href="assets/_old/css/style-responsive.css" rel="stylesheet">
    ...
    <script src="assets/_old/js/chart-master/Chart.js"></script>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="index.php" class="logo"><b style="color: white">Padang Tourism</b></a>
        <div class="top-menu">
